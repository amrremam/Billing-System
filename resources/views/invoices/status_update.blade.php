            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Status_Update', ['id' => $invoices->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">Enter Invoice Number</label>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="Status" name="Status" required>
                                    <option selected="true" disabled="disabled">-- Chhose Payment Status --</option>
                                    <option value="Paid">Paid</option>
                                    <option value="Permannetly Paid">Permannetly Paid</option>
                                </select>
                            </div>
