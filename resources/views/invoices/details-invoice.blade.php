...
<div class="my-auto">
    <div class="d-flex">
        <h4 class="content-title mb-0 my-auto">Invoices Menu </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                            ...
                            <div class="tab-content">
                                        ...
                                        <table class="table table-striped" style="text-align:center">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="row">Coll amount</th>
                                                    <td>{{ $invoices->Amount_collection }}</td>
                                                    <th scope="row">Comm amount</th>
                                ...
                                <div class="tab-pane" id="tab6">
                                    ...
                                    <div class="card card-statistics">
                                        {{-- @can(' Add Attachment') --}}
                                            <div class="card-body">
                                                <p class="text-danger">* Attachment Formula pdf, jpeg ,.jpg , png </p>
    ...
    <div class="modal-content">
        ...
        <form action="{{ route('delete_file') }}" method="post">
            ...
            <div class="modal-body">
                <p class="text-center">
                <h6 style="color:red">Delete Attachments Sure?</h6>
                </p>
